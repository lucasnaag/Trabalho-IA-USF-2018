...
public class Agente extends JPanel implements Runnable{
    ...
    public Agente()
    {
        ...
        for (int i = 0; i < iminigos.length; i = i + DIAMETRO) {
            for (int j = 0; j < iminigos[i].length; j = j + DIAMETRO) {
